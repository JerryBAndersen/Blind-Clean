Shader "Tesselation" {
    ...
    SubShader {
        ...
        #pragma surface surf Standard finalcolor:mycolor vertex:disp tessellate:tessFixed tessphong:_Phong
        #pragma target 5.0
        ...
        {			
			...
			float2 coord = float2(0.5,(distance(_Origin, v.vertex) / _VisibleDistance));
			//d += tex2Dlod (_Secondary, float4(coord.xy,0,0)).r/10.0;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			//o.Albedo = c.rgb;			
			//o.Albedo += tex2D (_Secondary, IN.uv_MainTex) * _SecondaryColor;			
